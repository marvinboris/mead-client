...
const footer = ({}) => (
    <>
                        ...
                        <Row>
                            ...
                            <Col lg={6}>
                                ...
                                <ul className="fa-ul mb-3 p-0 ml-4">
                                    ...
                                    <li><FontAwesomeIcon icon="phone" className="fa-li text-danger mr-2" /><NavLink className="text-reset" to="tel://+237656395217">(+237) 656-395-217</NavLink></li>
                                    <li><FontAwesomeIcon icon="envelope" className="fa-li text-danger mr-2" />contact@mead.com</li>
                                </ul>
        ...
        <footer className="text-center bg-light text-secondary py-5">
            <Container>
                Copyright &copy; 2019. Tous droits réservés. | Designed by <NavLink to="mailto:jaris.ultio.21@gmail.com"><span className="text-info">Brainer</span> <span className="text-danger">21</span></NavLink>
            </Container>
        </footer>
    </>
);
