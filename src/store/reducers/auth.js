...
const joinCommunityStart = (state, action) => updateObject(state, { loading: true });
const joinCommunitySuccess = (state, action) => updateObject(state, { loading: false, profile: action.payload.profile });
const joinCommunityFail = (state, action) => updateObject(state, { loading: false, error: action.payload });

const quitCommunityStart = (state, action) => updateObject(state, { loading: true });
const quitCommunitySuccess = (state, action) => updateObject(state, { loading: false, profile: action.payload.profile });
const quitCommunityFail = (state, action) => updateObject(state, { loading: false, error: action.payload });
...
const reducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.JOIN_COMMUNITY_START: return joinCommunityStart(state, action);
        case actionTypes.JOIN_COMMUNITY_SUCCESS: return joinCommunitySuccess(state, action);
        case actionTypes.JOIN_COMMUNITY_FAIL: return joinCommunityFail(state, action);
        
        case actionTypes.QUIT_COMMUNITY_START: return quitCommunityStart(state, action);
        case actionTypes.QUIT_COMMUNITY_SUCCESS: return quitCommunitySuccess(state, action);
        case actionTypes.QUIT_COMMUNITY_FAIL: return quitCommunityFail(state, action);
